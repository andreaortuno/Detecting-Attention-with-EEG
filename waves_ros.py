...
class DynamicUpdate():
    ...
    max_x = 1000
    step = 10
    def hello(self, alpha, beta):
        if not rospy.is_shutdown():
            rate = rospy.Rate(10)
            rospy.loginfo([alpha, beta])
            arr = Float32MultiArray(data=[alpha,beta])
    ...
    def on_launch(self):
        ...
        self.pub = rospy.Publisher('waves', Float32MultiArray, queue_size=10)
